...
KITTY_CONFIG=$WORKSPACE_DIR/dev-env/kitty/config
KITTY_SESSION_TEMPLATE=$WORKSPACE_DIR/dev-env/kitty/session
KITTY_SESSION_NEW=$WORKSPACE_DIR/dev-env/kitty/session.new
